...
function MainFooter(props) {
  const tradingName = props.data.business ? props.data.business.tradingName || '' : '';

  return (
    <>
      <header className="py-3 m-3 mt-4 border-top">
        <div className="container">
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">

            <span className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center text-center mb-md-0 text-body-secondary">
              © {new Date().getFullYear()} {tradingName} x harlyy.com
            </span>
